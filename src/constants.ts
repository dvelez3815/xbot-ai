...
export const EnvKeys = {
  ...
  BOT_POST_VARIANTS: "BOT_POST_VARIANTS",
  BOT_POSTS_PER_DAY: "BOT_POSTS_PER_DAY",
  BOT_DELAY_BETWEEN_POSTS_SECONDS: "BOT_DELAY_BETWEEN_POSTS_SECONDS",
  BOT_REPLY_ENABLED: "BOT_REPLY_ENABLED",
  BOT_REPLY_CHANCE_PERCENT: "BOT_REPLY_CHANCE_PERCENT",
  ...
  BOT_HISTORY_FILE: "BOT_HISTORY_FILE",
  BOT_HISTORY_TTL_DAYS: "BOT_HISTORY_TTL_DAYS",
  // System
  DEBUG: "DEBUG",
  LOG_FILE: "LOG_FILE",
} as const;
